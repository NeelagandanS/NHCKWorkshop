...
const initGame = () => {
    ...
    snakeBody[0] = [snakeY, snakeX]; // Setting first element of snake body to current snake position
    ...
    for (let i = 0; i < snakeBody.length; i++) {
        ...
        html += `<div class="head" style="grid-row: ${snakeBody[i][0]}; grid-column: ${snakeBody[i][1]};"></div>`;
